 ...
 * @author xyh10
 */
public class AgentManagementPanel extends javax.swing.JPanel {

    /**
     * Creates new form AgentManagementPanel
     */
    Business business;
    ...
    public AgentManagementPanel(Business business, UserAccount userAccount) {
        initComponents();
    ...
    public void populate(){
        ...
        for(DeliveryAgent c:business.getDeliveryAgentDirectory().getAgentList()){
    ...
    private void initComponents() {
        ...
        addAgentBtn.setText("Add Delivery Agent");
        addAgentBtn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                addAgentBtnActionPerformed(evt);
            }
        });
        add(addAgentBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 460, -1, -1));
    ...
    private void addAgentBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addAgentBtnActionPerformed
        ...
        if(uad.UserAccountExist(fieldUserName.getText(),fieldPassword.getText() , "Agent")){
            JOptionPane.showMessageDialog(null, "Sorry credentials are taken.");
        }else{
            UserAccount ua = business.getUserAccountDirectory().createUserAccount(fieldUserName.getText(),fieldPassword.getText(), "Agent" );
            business.getDeliveryAgentDirectory().createDeliveryAgent(ua.getAccountID(), fieldName.getText(),fieldAge.getText() );
            populate();
        }
